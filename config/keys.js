...
module.exports = {
    google: {
        ...
        callbackURL   : 'https://eexpertise.herokuapp.com/auth/google/callback' // App callback
    },
    facebook: {
        clientID      : '1067492386733102', // App ID
        clientSecret  : '952e43ec454ee95fd5601f0f00340791', // App Secret
        callbackURL   : 'https://eexpertise.herokuapp.com/auth/facebook/callback', // App callback
    ...
    twitter: {
        ...
        callbackURL     : 'https://eexpertise.herokuapp.com/auth/twitter/callback' // App callback
    },
    mongodb: {
